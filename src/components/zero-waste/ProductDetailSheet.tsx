      ...
      {product && (
        <>
          ...
          <motion.div
            ...
            className="absolute inset-x-0 bottom-0 z-50 max-h-[92%] overflow-y-auto zw-scroll bg-white"
            style={{
          ...
          >
            ...
            <button
              onClick={() => setActiveProduct(null)}
              className="absolute right-4 top-5 z-20 flex h-9 w-9 items-center justify-center rounded-full bg-white"
              style={{ boxShadow: "0 4px 12px rgba(17, 24, 39, 0.1)" }}
            >
            ...
            {/* Hero image */}
            <div
              className={`relative h-60 w-full overflow-hidden bg-gradient-to-br ${product.imageColor}`}
              style={{ borderTopLeftRadius: 32, borderTopRightRadius: 32 }}
            >
              <div className="absolute left-4 top-4 rounded-full bg-white px-3 py-1.5 text-[12px] font-bold text-[#16A34A]" style={{ boxShadow: "0 4px 12px rgba(17, 24, 39, 0.1)" }}>
                {discountPct}% OFF
              </div>
              {product.isAiMatch && (
                <div className="absolute right-16 top-4 flex items-center gap-1.5 rounded-full bg-[#16A34A] px-3 py-1.5" style={{ boxShadow: "0 4px 12px rgba(17, 24, 39, 0.1)" }}>
              ...
              <div className="flex h-full items-center justify-center">
                <span
                  className="text-8xl font-bold text-white/85"
            ...
            <div className="px-5 pb-32 pt-5">
              ...
              {/* Title */}
              <h2
                className="mt-2 text-2xl font-bold leading-tight tracking-tight text-[#111827]"
                style={{ fontFamily: displayFont }}
              >
                {product.name}
              </h2>
              ...
              <div className="mt-3 flex items-end gap-3">
                ...
                <span className="mb-1 text-base text-[#94a3b8] line-through">
                  {formatINR(product.originalPrice)}
                </span>
                <span className="mb-1.5 rounded-full bg-[#f0fdf4] px-2.5 py-1 text-[11px] font-bold text-[#16A34A]">
              ...
              {/* AI freshness card */}
              <div
                className="mt-5 overflow-hidden p-5"
                style={{
                  borderRadius: 28,
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="ml-auto text-[11px] font-bold text-[#16A34A]">
            ...
            {/* Sticky bottom CTA */}
            <div className="absolute inset-x-0 bottom-0 bg-white px-5 py-3" style={{ boxShadow: "0 -4px 20px rgba(17, 24, 39, 0.06)" }}>
              <div className="flex items-center gap-3">
                <div className="flex h-12 items-center rounded-[22px] bg-[#f1f5f9] px-1">
                  <button
                    onClick={() => setQty((q) => Math.max(1, q - 1))}
                    className="flex h-10 w-10 items-center justify-center rounded-xl text-[#111827] active:scale-90"
                  >
                    <Minus size={16} />
                  </button>
                  <span
                ...
                <motion.button
                  ...
                  className="flex h-12 flex-1 items-center justify-between text-white"
                  style={{
                    borderRadius: 22,
                ...
                >
                  <span className="text-[13px] font-semibold pl-4">
...
function TrustBadge({
  ...
  return (
    <div className="flex flex-col items-center gap-1 bg-white p-2.5 text-center" style={{ borderRadius: 22, boxShadow: "0 2px 8px rgba(17, 24, 39, 0.04)" }}>
      {icon}
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute inset-x-0 bottom-0 z-50 max-h-[85%] overflow-y-auto zw-scroll bg-white"
            style={{
              borderRadius: "32px 32px 0 0",
              boxShadow: "0 -8px 32px rgba(17, 24, 39, 0.12)",
            }}
          >
            <div className="sticky top-0 z-10 flex items-center justify-between bg-white px-5 py-3 border-b border-[#f1f5f9]">
              <div className="flex items-center gap-2">
                <div className="h-1.5 w-10 rounded-full bg-[#e2e8f0] absolute left-1/2 top-1.5 -translate-x-1/2" />
                <h3
            ...
            {cart.length === 0 ? (
              <div className="flex flex-col items-center justify-center px-5 py-16 text-center">
                ...
                <button
                  ...
                  className="mt-4 px-5 py-2.5 text-[13px] font-semibold text-white"
                  style={{
                    borderRadius: 22,
                    background: "linear-gradient(135deg, #16a34a, #15803d)",
                  }}
              ...
              <>
                <div className="px-5 py-4">
                  {cart.map((item, i) => (
                    ...
                    >
                      <div
                        className={`flex h-16 w-16 flex-shrink-0 items-center justify-center bg-gradient-to-br ${item.product.imageColor}`}
                      ...
                      <div className="flex-1">
                        <h4
                          className="line-clamp-1 text-[13px] font-bold text-[#111827]"
                          style={{ fontFamily: displayFont }}
                        >
                          {item.product.name}
                        </h4>
                      ...
                      <div className="flex flex-col items-end justify-between">
                        <button
                          ...
                          className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#fef2f2] text-[#ef4444] active:scale-90"
                        >
                          <Trash2 size={14} />
                        </button>
                        <div className="flex h-8 items-center rounded-xl bg-[#f1f5f9]">
                          <button
                            onClick={() =>
                              updateQty(item.product.id, item.qty - 1)
                            }
                            className="flex h-8 w-7 items-center justify-center text-[#111827] active:scale-90"
                          >
                            <Minus size={12} />
                          </button>
                          <span
                ...
                {/* Savings banner */}
                <div className="mx-5 mb-3 flex items-center gap-2 px-4 py-3" style={{ borderRadius: 22, background: "linear-gradient(135deg, #16a34a, #15803d)" }}>
                ...
                {/* Bill summary */}
                <div className="mx-5 mb-3 bg-white p-5" style={{ borderRadius: 28, boxShadow: "0 2px 12px rgba(17, 24, 39, 0.05)" }}>
                  <h4
                    className="text-sm font-bold text-[#111827]"
                    style={{ fontFamily: displayFont }}
                  >
                ...
                {/* Checkout CTA */}
                <div className="sticky bottom-0 bg-white px-5 py-3" style={{ boxShadow: "0 -4px 20px rgba(17, 24, 39, 0.06)" }}>
                  <motion.button
                    whileTap={{ scale: 0.97 }}
